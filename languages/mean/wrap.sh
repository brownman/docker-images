...
docker run -p 3000:3000 -p 35729:35729  --link mongo_deamon:db -t brownman/mean bash -c 'env; source ~/.bashrc; cd myApp; npm link; mean status; node_modules/grunt-cli/bin/grunt test; node_modules/grunt-cli/bin/grunt'
#< test.sh
